Rails.application.routes.draw do
  ...
  # CREATE
  get("/insert_comment/:path_id", { :controller => "comments", :action => "create" })
  ...
  # CREATE
  get("/insert_follow_request/:path_id", { :controller => "follow_requests", :action => "create" })
  ...
  # CREATE
  get("/insert_like/:path_id", { :controller => "likes", :action => "create" })
  ...
  get("/update_user", { :controller => "user_authentication", :action => "modify" })
